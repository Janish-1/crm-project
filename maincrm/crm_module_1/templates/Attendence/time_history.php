...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Time Histories</h5>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea class="form-control" name="description"
                                                            rows="4">{{ timehistory.description }}</textarea>
                                                    </div>
                                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="CreateForm" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                            ...
                            <!-- Clock In Field -->
                            <div class="row mb-3">
                                <label for="inputClockIn" class="col-sm-2 col-form-label">Clock In</label>
                                <div class="col-sm-10">
                                    <input type="time" class="form-control" name="clockin" value="">
                                </div>
                            </div>

                            <!-- Clock Out Field -->
                            <div class="row mb-3">
                                <label for="inputClockOut" class="col-sm-2 col-form-label">Clock Out</label>
                                <div class="col-sm-10">
                                    <input type="time" class="form-control" name="clockout" value="">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label for="inputLate" class="col-sm-2 col-form-label">Late</label>
                                <div class="col-sm-10">
                                    <input type="checkbox" class="form-check-input" name="late" value="on">
                                </div>
                            </div>
