...
urlpatterns = [
    ...
    path('project-reports/', views.ProjectReportAPIView.as_view(), name='project-report-list'),
    path('project-reports/<int:projectid>/', views.ProjectReportAPIView.as_view(), name='project-report-detail'),
